...
def index():
    params = {}
    params['user'] = 'дорогой читатель'
    params['title'] = 'АВТОРИЗАЦИЯ ПРОЙДЕНА'
    params['weather'] = 'Поздравляем, Вы успешно авторизировались на нашем сайте! Предлагаем Вам прочесть произведение и написать на него рецензию!'
